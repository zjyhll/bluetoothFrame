...
import com.hwacreate.outdoor.adater.utl.MyList4Adpter;
...
import com.keyhua.outdoor.protocol.GetLeaderOptionalActivityListAction.GetLeaderOptionalActivityListActivitylistItem;
import com.keyhua.outdoor.protocol.GetLeaderOptionalActivityListAction.GetLeaderOptionalActivityListRequest;
import com.keyhua.outdoor.protocol.GetLeaderOptionalActivityListAction.GetLeaderOptionalActivityListRequestParameter;
import com.keyhua.outdoor.protocol.GetLeaderOptionalActivityListAction.GetLeaderOptionalActivityListResponse;
import com.keyhua.outdoor.protocol.GetLeaderOptionalActivityListAction.GetLeaderOptionalActivityListResponsePayload;
 ...
 * @下午4:41:11
 */
public class KeXuanHuoDongActivity extends BaseActivity implements OnItemClickListener {
	// 上拉下拉刷新
	private LoadMoreListViewContainer loadMoreListViewContainer = null;
	private ListView lv_home = null;// listView
	private MyList4Adpter listadapter = null;
	private PtrFrameLayout mPtrFrameLayout;
	private List<GetLeaderOptionalActivityListActivitylistItem> list = null;
	private List<GetLeaderOptionalActivityListActivitylistItem> listTemp = null;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_kexuanhuodong);
		init();
	}
	...
	protected void onInitData() {
		initHeaderOther();
		list = new ArrayList<GetLeaderOptionalActivityListActivitylistItem>();
		listTemp = new ArrayList<GetLeaderOptionalActivityListActivitylistItem>();
	}

	@Override
	protected void onResload() {
		top_tv_title.setText("可选活动");
	...
	public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
		...
		bundle.putInt("fromrenwu", CommonUtility.XianShiTab_Leader);
	...
	private void refreshAndLoadMore() {
		...
		loadMoreListViewContainer.setLoadMoreHandler(new LoadMoreHandler() {
			...
			public void onLoadMore(LoadMoreContainer loadMoreContainer) {
				if (NetUtil.isNetworkAvailable(KeXuanHuoDongActivity.this)) {// 有网
					if (listadapter != null) {
	...
	public void Action() {
		GetLeaderOptionalActivityListRequest request = new GetLeaderOptionalActivityListRequest();
		request.setAuthenticationToken(App.getInstance().getAut());
		GetLeaderOptionalActivityListRequestParameter parameter = new GetLeaderOptionalActivityListRequestParameter();
		...
		if (responseObject != null) {
			try {
				...
				if (ret == 0) {
					GetLeaderOptionalActivityListResponse response = new GetLeaderOptionalActivityListResponse();
					try {
					...
					// 处理返回的参数，需要强制类型转换
					GetLeaderOptionalActivityListResponsePayload payload = (GetLeaderOptionalActivityListResponsePayload) response
							.getPayload();
			...
			case CommonUtility.SERVEROK1:
				...
				if (list.size() == 0) {
					if (listadapter3 == null) {
						...
						nodatas.add(nodata);
						listadapter3 = new CommonAdapter<NoDataBean>(KeXuanHuoDongActivity.this, nodatas,
					...
					if (Loadmore && listadapter != null) {
						...
						listadapter3 = null;
						listadapter = new MyList4Adpter(KeXuanHuoDongActivity.this, list, imageLoaderRectF, mImageLoader,
								options);
