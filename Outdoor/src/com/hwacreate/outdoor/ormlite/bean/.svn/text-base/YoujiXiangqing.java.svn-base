...
@DatabaseTable(tableName = "outdoor_tb_youjixiangqing")
public class YoujiXiangqing {
	...
	@DatabaseField(columnName = "tvl_desc_intro")
	private String tvl_desc_intro; // 参加活动费用
	...
	public String getTvl_desc_intro() {
		return tvl_desc_intro;
	}

	public void setTvl_desc_intro(String tvl_desc_intro) {
		this.tvl_desc_intro = tvl_desc_intro;
	}
	...
	public YoujiXiangqing(String footprint_data, String act_end_time, String tvl_title, String picture_url,
			String tvl_desc, String anchor_longitude, String act_id, String anchor_latitude, String team_ember,
			String u_id, String act_start_time, String city, String scenicsots, Integer is_collect, Integer distance,
			String leader_id, Integer team_number, String act_type, String leader_name, String tvl_cover,
			String tvl_type, String tvl_id, String trace_data, Integer type, 
			String user_nickname,
			String club_name, Integer agreeCount, Integer isAgree, String team_member, String act_strategy,
			String logistics, Integer act_join_num_limit, Integer confirmed_member, Integer viceleadercount,
			Integer malecount, Integer femalecount, String act_entry_fee, String act_weixin, String act_most_equip,
			Integer act_level, String tvl_else, String club_logo, String head, String tvl_create_time,
			String tvl_desc_intro) {
		this.footprint_data = footprint_data;
		this.act_end_time = act_end_time;
		this.tvl_title = tvl_title;
		this.picture_url = picture_url;
