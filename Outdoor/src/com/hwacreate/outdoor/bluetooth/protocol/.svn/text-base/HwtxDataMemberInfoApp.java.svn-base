...
__packed typedef union _tag_MEMBER_MEMBERINFOAPP_U_
{
	unsigned char v;
	__packed struct __tag_MEMBERINFOAPP_T_
	{
		unsigned uIsAttend : 1;     //该编号成员是否参加了这次活动。0-未参加，1-参加了本次活动
		unsigned uIsUseAPP : 1;     //该编号成员是否启用APP图标. 0-未使用队员APP，1-使用了队员APP
		unsigned uRev:6;						//Reserved bit，暂未定义
	}bit_info;
