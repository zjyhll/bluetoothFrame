...
public class MyListAdpter extends BaseAdapter {
	...
	public MyListAdpter(Context context, List<HomeTapDangjiBean> list, ImageLoader imageLoader,
			com.nostra13.universalimageloader.core.ImageLoader mImageLoader, DisplayImageOptions option) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			convertView = LayoutInflater.from(context).inflate(R.layout.item_homelist_zhuye, null);
		...
		if (mDatas.get(position).getIssignup() == 1) {
