...
public class MyList4Adpter extends BaseAdapter {
	private Context context = null;
	public List<GetLeaderOptionalActivityListActivitylistItem> mDatas = null;
	private ImageLoader imageLoader = null;
	private com.nostra13.universalimageloader.core.ImageLoader mImageLoader = null;
	private DisplayImageOptions options;

	public MyList4Adpter(Context context, List<GetLeaderOptionalActivityListActivitylistItem> list,
