...
public class MyList3Adpter extends BaseAdapter {
	private Context context = null;
	public List<GetMyOrderActivityListActivitylistItem> mDatas = null;
	private ImageLoader imageLoader = null;
	private com.nostra13.universalimageloader.core.ImageLoader mImageLoader = null;
	private DisplayImageOptions options;

	public MyList3Adpter(Context context, List<GetMyOrderActivityListActivitylistItem> list, ImageLoader imageLoader,
			com.nostra13.universalimageloader.core.ImageLoader mImageLoader, DisplayImageOptions options) {
